 ...
 */
final class Version20220113234032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stage CHANGE code id_entreprise_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stage CHANGE id_entreprise_id code INT NOT NULL');
    }
}
